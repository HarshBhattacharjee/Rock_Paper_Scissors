...
document.querySelector(".newRules").addEventListener("click", function() {
    document.querySelector(".newGameRules").classList.toggle("show");
});

document.querySelector(".closeButton").addEventListener("click", function() {
    document.getElementById("gameRules").classList.remove("show");
});
document.querySelector(".newCloseButton").addEventListener("click", function() {
    document.querySelector(".newGameRules").classList.remove("show");
});

document.querySelector(".next").addEventListener("click", function () {
    document.querySelector("#screen").style.display = "none";
    document.querySelector(".win").style.display = "flex";
    if (window.getComputedStyle(document.querySelector(".gameRules")).visibility == "visible")
    {
        document.getElementById("gameRules").classList.toggle("show");
        document.querySelector(".newGameRules").classList.toggle("show");
    }
...
const playAgain = () => {
    ...
    if (window.getComputedStyle(document.querySelector(".newGameRules")).visibility == "visible")
    {
        document.getElementById("gameRules").classList.toggle("show");
        document.querySelector(".newGameRules").classList.toggle("show");
    }
